...
for i = 1:length(h.lfp.ax)
    ...
    if strcmp(cond.type,'led')
        addStimulusBar(h.lfp.ax(i),[w.stim ymax*0.91],'',red,1.5);
%                         addStimulusBar(h.lfp.ax(i),[0.75 1.25 ymax*0.89],'',red,1.5);
    end
end
...
for i = 1:length(h.psth.ax)
    ...
    if strcmp(cond.type,'led')
        addStimulusBar(h.psth.ax(i),[w.stim ymax*0.91],'',red,1.5);
%                         addStimulusBar(h.psth.ax(i),[0.75 1.25 ymax*0.91],'',red,1.5);
    end
end
