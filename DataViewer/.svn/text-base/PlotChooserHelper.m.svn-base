...
if nActiveChannels < length(handles.hAllAxes)
    BlankEntries = {'' '' ''};
    BlankEntries = repmat(BlankEntries,(length(handles.hAllAxes)-nActiveChannels),1);
    handles.ChannelInfo = [handles.ChannelInfo; BlankEntries];
end
%set(handles.DaqTable1,'Data',handles.ChannelInfo(1:12,:));
set(handles.DaqTable1,'Data',handles.ChannelInfo(1:11,:));
%set(handles.DaqTable2,'Data',handles.ChannelInfo(13:length(handles.hAllAxes),:));
